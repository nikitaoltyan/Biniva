...
struct MainConstants {
    ...
    static let white = UIColor(named: "customWhiteColor") ?? UIColor(red: 245/255, green: 252/255, blue: 251/255, alpha: 1)
    ...
    static let nearWhite = UIColor(named: "customNearWhiteColor") ?? UIColor(red: 0, green: 0, blue: 0, alpha: 0.03)
